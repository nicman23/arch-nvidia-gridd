...
pkgbase=nvidia-550xx-grid-dkms
...
sha512sums=('de7116c09f282a27920a1382df84aa86f559e537664bb30689605177ce37dc5067748acf9afd66a3269a6e323461356592fdfc624c86523bf105ff8fe47d3770'
            ...
            'a5a27f32dac86194435854cc569464cc2d92f9421b80d0bb55cb50ce0cbb3ba5d25c952ccb66ecdef396a10d65596bc6a6f6298b5979ef607a360f3e59508e2b' )
...
package_nvidia-550xx-utils() {
    ...
    mkdir -p ${pkgdir}/etc/nvidia/ClientConfigToken
    mkdir -p ${pkgdir}/var/lib/nvidia/GridLicensing
    ...
    install -Dm755 nvidia-gridd "${pkgdir}/usr/bin/nvidia-gridd"
